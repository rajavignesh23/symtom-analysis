...
def read_evidences():
    file_name = '/mnt/c/gpy/Differential-Diagnosis-Using-Transformers/data/release_evidences.json'
    evidence_list = []
...
def read_conditions():
    file_name = '/mnt/c/gpy/Differential-Diagnosis-Using-Transformers/data/release_conditions.json'
    condition_list = []
