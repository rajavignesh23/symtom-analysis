...
def load_dataset(batch_size, num_workers):
    train_data = DDxDataset(filename='/mnt/c/gpy/Differential-Diagnosis-Using-Transformers/data/release_train_patients.csv')
    test_data = DDxDataset(filename='/mnt/c/gpy/Differential-Diagnosis-Using-Transformers/data/release_test_patients.csv')
